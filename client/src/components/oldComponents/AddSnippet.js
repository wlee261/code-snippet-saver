...
const AddSnippet = ({ snippetData, setSnippetData }) => {
  ...
  const handleNewFolderSubmit = async (e) => {
    e.preventDefault();
    dispatch(createFolder({ folderName: snippetData.folder }));
    clear();
  };
  ...
  return (
    <Accordion>
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          <Form onSubmit={handleNewSnippetSubmit}>
            ...
            <Form.Group controlId="formDescription">
              ...
              <Form.Control
                placeholder="Add a description for your code snippet"
            ...
            <Form.Group controlId="tags">
              ...
              <Form.Control
                placeholder="Add tags to your snippet, seperated by commas"
                value={snippetData.tags}
                onChange={(e) =>
                  setSnippetData({ ...snippetData, tags: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header>Create New Folder</Accordion.Header>
        <Accordion.Body>
