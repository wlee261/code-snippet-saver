    ...
    <>
      <Card style={{ width: "40rem" }}>
        <Card.Body>
          <Row>
            <Col>
              <Card.Text>Folder: {snippet.folder}</Card.Text>
            </Col>
            <Col>
          ...
          <Row>
            <Card.Text>Language: {snippet.language}</Card.Text>
            <Card.Text>Tags: {snippet.tags}</Card.Text>
            <CopyBlock
              text={snippet.code}
              ...
              codeblock
            />
            <Card.Text>Description: {snippet.description}</Card.Text>
          </Row>
        </Card.Body>
      </Card>
